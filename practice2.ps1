...
$hash3 = @{}
$hash3 = @{Name=$hash1.Name[0]; Salary=$hash1.DaysWorked[0] * $hash2.SalaryPerDay[0]}
$hash3 = @{Name=$hash1.Name[1]; Salary=$hash1.DaysWorked[1] * $hash2.SalaryPerDay[1]}
$hash3 = @{Name=$hash1.Name[2]; Salary=$hash1.DaysWorked[2] * $hash2.SalaryPerDay[2]}
